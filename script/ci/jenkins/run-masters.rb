...
def run_masters(xtc_device_set, xtc_profile, xtc_series)
  ...
  Dir.chdir working_dir do
    ...
    do_system("git clone --depth 1 --branch master --recursive https://github.com/jmoody/briar #{briar_repo_name}")
